  ...
  return (
    <div>
      ...
      <div className="flex flex-col sm:flex-row items-start gap-5 mt-5">
        <button
          className={`1py-1 px-3 border rounded text-sm transition-all sm:hidden ${
        ...
        >
          <p
            ...
            className={`w-[94vw] sm:w-auto  pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cusron-pointer ${
              speciality === "General physician"
